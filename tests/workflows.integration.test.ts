...
import {createActivityAction,createExpenseAction,createFieldNoteAction,adjustStockAction,updateIssueStatusAction,updateTaskStatusAction} from "@/app/actions";
...
const created={activities:[] as string[],tasks:[] as string[],expenses:[] as string[],notes:[] as string[],issues:[] as string[],otherFarm:"",otherItem:""};
